...
stopping_criteria_functional_value=0.01
...
def Cyclic_CoOrdinate_Method(expression,x_k,k,stopping_criteria_functional_value=None,stopping_criteria_individual_dimension=None):
    ...
    if stopping_criteria_functional_value!=None:
        ...
        if Stopp_Value>stopping_criteria_functional_value:
            return Cyclic_CoOrdinate_Method(expression,x_k,k=k,stopping_criteria_functional_value=stopping_criteria_functional_value)
    ...
    if stopping_criteria_individual_dimension!=None:
        ...
        if stop==0:
            return Cyclic_CoOrdinate_Method(expression,x_k,k=k,stopping_criteria_individual_dimension=stopping_criteria_individual_dimension)

Point_CoOrdinates={}
for i in x_k:
    Point_CoOrdinates[i]=[x_k[i]]

Cyclic_CoOrdinate_Method(expression, x_k, k=1, stopping_criteria_individual_dimension=stopping_criteria_individual_dimension)
#Cyclic_CoOrdinate_Method(expression, x_k, k=1, stopping_criteria_functional_value=stopping_criteria_functional_value)
print(Point_CoOrdinates)
wb.save("Cyclic_Co-ordinate.xlsx")
...
plt.savefig("{}".format("CyClic CoOrdinate Method.png"))